                                ...
                                <div class="bg-gradient-primary border-radius-lg h-100">
                                    ...
                                    <div class="position-relative d-flex align-items-center justify-content-center h-100">
                                        <img class="w-100 position-relative z-index-2 pt-4"
                                            src="{{ asset('soft-ui-dashboard-main') }}/assets/img/illustrations/rocket-white.png"
                                            alt="rocket">
                                    </div>
                                </div>
                            </div>
                                ...
                                <tbody>
                                    <tr>
                                        <td>
                                            <div class="d-flex px-2 py-1">
                                                <div>
                                                    <img src="{{ asset('soft-ui-dashboard-main') }}/assets/img/small-logos/logo-xd.svg"
                                        ...
                                        <td>
                                            <div class="avatar-group mt-2">
                                                <a href="javascript:;" class="avatar avatar-xs rounded-circle"
                                                    ...
                                                    title="Ryan Tompson">
                                                    <img src="{{ asset('soft-ui-dashboard-main') }}/assets/img/team-1.jpg"
                                                        alt="team1">
                                                </a>
                                                <a href="javascript:;" class="avatar avatar-xs rounded-circle"
                                                    data-bs-toggle="tooltip" data-bs-placement="bottom"
                                                    title="Romina Hadid">
                                                    <img src="{{ asset('soft-ui-dashboard-main') }}/assets/img/team-2.jpg"
                                                        alt="team2">
                                                </a>
                                                <a href="javascript:;" class="avatar avatar-xs rounded-circle"
                                                    data-bs-toggle="tooltip" data-bs-placement="bottom"
                                                    title="Alexander Smith">
                                                    <img src="{{ asset('soft-ui-dashboard-main') }}/assets/img/team-3.jpg"
                                                        alt="team3">
                                                </a>
                                                <a href="javascript:;" class="avatar avatar-xs rounded-circle"
                                                    data-bs-toggle="tooltip" data-bs-placement="bottom" title="Jessica Doe">
                                                    <img src="{{ asset('soft-ui-dashboard-main') }}/assets/img/team-4.jpg"
                                                        alt="team4">
                                                </a>
                                            </div>
                                        </td>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex px-2 py-1">
                                                <div>
                                                    <img src="{{ asset('soft-ui-dashboard-main') }}/assets/img/small-logos/logo-atlassian.svg"
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex px-2 py-1">
                                                <div>
                                                    <img src="{{ asset('soft-ui-dashboard-main') }}/assets/img/small-logos/logo-slack.svg"
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex px-2 py-1">
                                                <div>
                                                    <img src="{{ asset('soft-ui-dashboard-main') }}/assets/img/small-logos/logo-spotify.svg"
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex px-2 py-1">
                                                <div>
                                                    <img src="{{ asset('soft-ui-dashboard-main') }}/assets/img/small-logos/logo-jira.svg"
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex px-2 py-1">
                                                <div>
                                                    <img src="{{ asset('soft-ui-dashboard-main') }}/assets/img/small-logos/logo-invision.svg"
