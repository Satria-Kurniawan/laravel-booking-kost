...
<body class="g-sidenav-show  bg-gray-100">
    <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 "
        ...
        <div class="sidenav-header">
            ...
            <a class="navbar-brand m-0" href="{{ route('dashboard') }}" target="_blank">
                <img src="{{ asset('soft-ui-dashboard-main') }}/assets/img/logo-ct.png" class="navbar-brand-img h-100"
                    alt="main_logo">
        ...
        <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
            <ul class="navbar-nav">
                <li class="nav-item">
                    <a class="nav-link" href="{{ url('/') }}">
                        <div
                            ...
                            <i class="fa-solid fa-home text-dark"></i>
                        </div>
                ...
                <li class="nav-item">
                    <a class="nav-link {{ Route::is('dataRuangan') ? 'active' : '' }}"
                        href="{{ route('dataRuangan') }}">
                        <div
                            class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                            <i class="fa-solid fa-building {{ Route::is('dataRuangan') ? 'text-white' : 'text-dark'}}"></i>
                        </div>
        ...
        <div class="sidenav-footer mx-3 ">
            <div class="card card-background shadow-none card-background-mask-secondary" id="sidenavCard">
                <div class="full-background"
                    style="background-image: url('{{ asset('soft-ui-dashboard-main') }}/assets/img/curved-images/white-curved.jpg')">
                </div>
    ...
    <script>
        ...
        // image preview sebelum di upload
